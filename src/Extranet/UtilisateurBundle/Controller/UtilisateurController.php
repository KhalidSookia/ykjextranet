...
class UtilisateurController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ExtranetUtilisateurBundle:Utilisateur')->findAll();
     ...
     * @Method("POST")
     * @Template("ExtranetUtilisateurBundle:Utilisateur:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ExtranetUtilisateurBundle:Utilisateur')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("ExtranetUtilisateurBundle:Utilisateur:edit.html.twig")
     */
